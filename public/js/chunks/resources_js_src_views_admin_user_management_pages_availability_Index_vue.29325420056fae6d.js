...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    saveAvailability: function saveAvailability() {
      ...
      fd.append("start_time", this.value.start_time);
      fd.append("end_time", this.value.end_time);
      fd.append("date", this.value.date);
      fd.append("status", this.value.status);
      fd.append("affiliate_id", this.value.affiliate_id);
      fd.append("employee_id", this.value.employee_id);
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/availability/store', fd).then(function (response) {
