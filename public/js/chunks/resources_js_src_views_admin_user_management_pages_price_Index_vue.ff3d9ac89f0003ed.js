        ...
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_2___default().get('https://api.example.com/exchange-rates');
            case 3:
              response = _context.sent;
              if (response.status === 200) {
                _this3.exchangeRates = response.data; // Assuming response.data is an object with exchange rates
              } else {
