...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup() {
    ...
    function saveAvailability() {
      var start_time = availabilities.value;
      var end_time = availabilities.value;
      var selectedDays = selectedDays.value;
      var validatedData = {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post('/availability/store', validatedData).then(function (response) {
        ...
        _vm._l(_vm.days, function (day, index) {
          return _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(_vm.selectedDays.day))]),
            ],
            1
          )
        }),
