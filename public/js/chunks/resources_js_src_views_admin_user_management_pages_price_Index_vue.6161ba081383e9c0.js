...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props, context) {
    ...
    function saveModal() {
      if (form.value.validate()) {
        ...
        fd.append("service_id", editedItem.value.service_id);
        fd.append("value", editedItem.value.service_id);
        fd.append("status", editedItem.value.status);
        console.log(editedItem.value.service.service_id);
  ...
  computed: {
    servicesWithPrice: function servicesWithPrice() {
      var _this = this;
      return this.data.map(function (prices) {
        var exchangeRate = _this.exchangeRates[_this.selectedCurrency];
        var convertedPrice = prices.value * exchangeRate;
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])((0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, prices), {}, {
