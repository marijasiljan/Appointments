...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup() {
    ...
    var verificationCode = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)('');
    var socialLink = [{
    ...
    var checkVerificationCode = function checkVerificationCode() {
      if (verificationCode.value) {
        var emailFromQuery = axios.post("/password/verify", {
          ...
          if (response.data.status === true) {
            router.push({
              name: 'auth-login',
              query: {
                successMessage: 'Your account is verified. You can log in now!'
              }
            });
          } else {
    ...
    return {
      ...
      icons: {
        ...
        mdiAccountCheckOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_4__.mdiAccountCheckOutline
      }
    };
  }
});
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    ...
                    [_vm._v(" " + _vm._s(_vm.$t("verificationCode")) + " ")]
                  ),
                ],
                1
              ),
