...
/* harmony export */ });
/* harmony import */ var vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vuetify/lib/components/VCheckbox */ "./node_modules/vuetify/lib/components/VCheckbox/VCheckbox.js");
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { staticClass: "demo-space-x" },
        [
          _c(vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_0__["default"], {
            attrs: { label: "Monday", value: "Monday" },
            model: {
              value: _vm.days,
              callback: function ($$v) {
                _vm.days = $$v
          ...
          _vm._v(" "),
          _c(vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_0__["default"], {
            attrs: { label: "Tuesday", value: "Tuesday" },
            model: {
              value: _vm.days,
              callback: function ($$v) {
                _vm.days = $$v
          ...
          _vm._v(" "),
          _c(vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_0__["default"], {
            attrs: { label: "Wednesday", value: "Wednesday" },
            model: {
              value: _vm.days,
              callback: function ($$v) {
                _vm.days = $$v
          ...
          _vm._v(" "),
          _c(vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_0__["default"], {
            attrs: { label: "Thursday", value: "Thursday" },
            model: {
              value: _vm.days,
              callback: function ($$v) {
                _vm.days = $$v
          ...
          _vm._v(" "),
          _c(vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_0__["default"], {
            attrs: { label: "Friday", value: "Friday" },
            model: {
              value: _vm.days,
              callback: function ($$v) {
                _vm.days = $$v
          ...
          _vm._v(" "),
          _c(vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_0__["default"], {
            attrs: { label: "Saturday", value: "Saturday" },
            model: {
              value: _vm.days,
              callback: function ($$v) {
                _vm.days = $$v
          ...
          _vm._v(" "),
          _c(vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_0__["default"], {
            attrs: { label: "Sunday", value: "Sunday" },
            model: {
              value: _vm.days,
              callback: function ($$v) {
                _vm.days = $$v
