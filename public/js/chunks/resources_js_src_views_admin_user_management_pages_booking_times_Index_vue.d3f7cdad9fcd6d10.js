...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup() {
    ...
    var tablesIndex = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_2__.ref)('initAvailability');
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.data.length > 0
        ? _c("AvailabilityTable", {
            key: _vm.tablesIndex,
            attrs: {
              availabilityTimeData: _vm.data,
              title: "availability",
              availability: _vm.availabilityTimeData,
            },
          })
        : _vm._e(),
    ],
  ...
  return _c(
    ...
    [
      _c("SimpleTable", {
        ...
        ref: "simpleTable",
        attrs: {
          items: _vm.availabilityTimeData,
          headers: _vm.headers,
