...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props, context) {
    ...
    var services = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__.ref)([]);
    ...
    function saveModal() {
      if (form.value.validate()) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_6___default().post('/price/store', fd).then(function (response) {
        ...
        return (0,C_Users_Riste_Desktop_MANGOSOFT_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              isLoading.value = true;
              axios__WEBPACK_IMPORTED_MODULE_6___default().put('/price/changeStatus', {
                'id': item.id,
        ...
        return (0,C_Users_Riste_Desktop_MANGOSOFT_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return confirmAlert({
                'subtitle': 'are_you_sure_you_want_to_delete'
              });
            case 2:
              if (!_context3.sent) {
                _context3.next = 5;
              ...
              isLoading.value = true;
              axios__WEBPACK_IMPORTED_MODULE_6___default().put("/price/".concat(item.id, "/delete"), {
                'id': item.id
              }).then(function (response) {
                if (response.data.status) {
  ...
  computed: {
    calculateConvertedPrices: function calculateConvertedPrices() {
      var _this = this;
      return this.data.map(function (item) {
        var exchangeRate = _this.exchangeRates[_this.selectedCurrency];
        var convertedPrice = item.value * exchangeRate;
        return (0,C_Users_Riste_Desktop_MANGOSOFT_Appointments_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])((0,C_Users_Riste_Desktop_MANGOSOFT_Appointments_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, item), {}, {
  ...
  return _c(
    ...
    [
      ...
      _c("SimpleTable", {
        ...
        ref: "simpleTable",
        attrs: {
          items: _vm.calculateConvertedPrices,
          headers: _vm.headers,
