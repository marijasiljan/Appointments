  ...
  setup: function setup(props, context) {
    ...
    function saveModal() {
      if (form.value.validate()) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_5___default().post(singlePath + '/store', fd).then(function (response) {
    ...
    function changeStatus(item) {
      isLoading.value = true;
      axios__WEBPACK_IMPORTED_MODULE_5___default().put(singlePath + '/changeStatus', {
        'id': item.id,
        ...
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              isLoading.value = true;
              axios__WEBPACK_IMPORTED_MODULE_5___default().put(singlePath + '/delete', {
                'id': item.id
              }).then(function (response) {
                if (response.data.status) {
                        ...
                        _c(
                          ...
                          [
                                          ...
                                          [
                                            ...
                                            _c(
                                              ...
                                              [
                                                ...
                                                _vm._v(" "),
                                                _c(vuetify_lib_components_VSwitch__WEBPACK_IMPORTED_MODULE_14__["default"], {
                                                  attrs: {
                                                    id: "newsletter",
                                                    inset: "",
                                                    "true-value": 1,
                            ...
                            _c(
                              ...
                              [
                                _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_15__["default"]),
                                _vm._v(" "),
                                _c(
                                  vuetify_lib_components_VBtn__WEBPACK_IMPORTED_MODULE_2__["default"],
                                  {
