...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup() {
    var newCustomerOptions = {
      ...
      statistics: '',
      change: '-10.2%',
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiAccountOutline,
      color: 'primary'
    };
        ...
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              if (response && response.data.data && response.data.data.count !== undefined) {
                newCustomerOptions.statistics = response.data.count.toString();
                console.log(newCustomerOptions.statistics);
              } else {
