  ...
  setup: function setup(props, context) {
    ...
    function saveModal() {
      if (form.value.validate()) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_5___default().post('/store', fd).then(function (response) {
    ...
    function changeStatus(item) {
      isLoading.value = true;
      axios__WEBPACK_IMPORTED_MODULE_5___default().put('/changeStatus', {
        'id': item.id,
        ...
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              isLoading.value = true;
              axios__WEBPACK_IMPORTED_MODULE_5___default().put("/services/".concat(item.id, "/delete"), {
                'id': item.id
              }).then(function (response) {
                if (response.data.status) {
    ...
    [
      ...
      _vm.data.length > 0
        ? _c("service-table", {
            ...
            attrs: { users: _vm.data, title: "services", services: "services" },
          })
        : _vm._e(),
    ],
    1
