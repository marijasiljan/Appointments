        ...
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              axios__WEBPACK_IMPORTED_MODULE_6___default().post('/admin/loginAsOtherUser', {
                'id': user.id
                ...
                if (response.data.status == true) {
                  ...
                  (axios__WEBPACK_IMPORTED_MODULE_6___default().defaults).headers.common['Authorization'] = responseData.token_type + ' ' + responseData.access_token;
                  store.dispatch('updateToken', responseData.access_token);
                  axios__WEBPACK_IMPORTED_MODULE_6___default().post("/getUser").then( /*#__PURE__*/function () {
