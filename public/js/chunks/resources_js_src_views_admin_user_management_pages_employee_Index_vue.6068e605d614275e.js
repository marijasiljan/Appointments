...
/* harmony import */ var C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/defineProperty.js */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "admin-users-emoployees-table",
  components: {
  ...
  setup: function setup(props, context) {
    ...
    function saveModal() {
      if (form.value.validate()) {
        ...
        fd.append("surname", editedItem.value.last_name);
        ...
        axios__WEBPACK_IMPORTED_MODULE_6___default().post(singlePath + '/users/store', fd).then(function (response) {
        ...
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              isLoading.value = true;
              axios__WEBPACK_IMPORTED_MODULE_6___default().put(singlePath + '/users/{id}/delete', {
                'id': item.id
              }).then(function (response) {
                if (response.data.status) {
    ...
    }, (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref, "simpleTableKey", "init"), (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref, "isLoading", false), (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref, "title", "Employee Table"), _ref;
  }
});
    ...
    [
      ...
      _vm.data.user
        ? _c("employee-table", {
            ...
            attrs: { user: _vm.data.user, title: "employee", role: "admin" },
          })
        : _vm._e(),
    ],
    1
                ...
                _c("div", [
                  _vm._v(
                    "\n          " +
                      ...
                      " " +
                      _vm._s(slotItems.item.surname) +
                      " "
                  ),
                  _c("br"),
                  _vm._v("\n          " + _vm._s(slotItems.item.email)),
                  _c("br"),
                  _vm._v("\n          " + _vm._s(slotItems.item.birthday)),
                  _c("br"),
                ]),
              ]
            },
                      ...
                      [
                        _c(vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_5__.VCardTitle, [
                          _c("div", { staticClass: "text-h5" }, [
                            _vm.editedItem.id != 0
                              ? _c("span", [
                                  _vm._v(_vm._s(_vm.editedItem.user.name)),
                                ])
                              : _vm._e(),
                          ]),
                        ]),
