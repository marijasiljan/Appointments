...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup() {
    ...
    var customersOptions = {
      ...
      chipColor: 'info',
      avatar: Object(function webpackMissingModule() { var e = new Error("Cannot find module 'resources/js/src/assets/images/avatars/11.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
      avatarWidth: '88'
    };
    var profitLineChart = {
      statTitle: 'Total Profit',
