...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props, context) {
    ...
    function changeStatus(item) {
      isLoading.value = true;
      axios__WEBPACK_IMPORTED_MODULE_5___default().put('/availability/changeStatus', {
        'id': item.id,
        ...
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              isLoading.value = true;
              axios__WEBPACK_IMPORTED_MODULE_5___default().put("/availability/".concat(item.id, "/delete"), {
                'id': item.id
              }).then(function (response) {
                if (response.data.status) {
