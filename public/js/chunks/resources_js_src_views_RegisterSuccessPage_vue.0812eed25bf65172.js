...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup() {
    ...
    var verificationCode = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_2__.ref)('');
    var socialLink = [{
    ...
    var checkVerificationCode = function checkVerificationCode() {
      if (verificationCode.value) {
        var emailFromQuery = _this.$route.query.email;
        axios.post("/password/verify/".concat(email), {
