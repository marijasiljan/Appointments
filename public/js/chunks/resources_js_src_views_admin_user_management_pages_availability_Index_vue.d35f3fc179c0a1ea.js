    ...
    generateSlots: function generateSlots() {
      ...
      for (var currentDate = startDate; currentDate <= endDate; currentDate = new Date(currentDate.getTime() + slotDuration)) {
        this.generatedSlots.push({
          ...
          // Add other properties like date, status, affiliate_id, and employee_id
          date: currentDate.toISOString().split('T')[0],
          status: '1'
          // affiliate_id: 1, // Replace with the actual affiliate ID
          // employee_id: 1, // Replace with the actual employee ID
        });
      }
    },
    saveAvailability: function saveAvailability() {
      // Send this.generatedSlots to your backend for storage in the database.
      // Implement the API call to store these slots.
      // Example: You can use Axios to make a POST request to your backend.
      // axios.post('/availability', this.generatedSlots).then(response => {
...
var render = function () {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("div", [
      _c("label", { attrs: { for: "date" } }, [_vm._v("Select Date:")]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
    ...
    _vm._v(" "),
    _c("div", [
      _c("label", { attrs: { for: "employee-id" } }, [_vm._v("Employee ID:")]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
        ...
        attrs: { type: "text", id: "employee-id" },
    ...
    _vm._v(" "),
    _c("div", [
      _c("label", { attrs: { for: "affiliate-id" } }, [
        _vm._v("Affiliate ID:"),
      ]),
      _vm._v(" "),
      _c("input", {
        ...
        attrs: { type: "text", id: "affiliate-id" },
        domProps: { value: _vm.affiliateId },
        on: {
          input: function ($event) {
            if ($event.target.composing) {
              return
            }
            _vm.affiliateId = $event.target.value
          },
        },
      }),
    ]),
      ...
      _c(
        ...
        _vm._l(_vm.generatedSlots, function (slot, index) {
          return _c("li", { key: index }, [
            _vm._v(_vm._s(slot.start_time) + " - " + _vm._s(slot.end_time)),
          ])
        }),
        0
      ),
