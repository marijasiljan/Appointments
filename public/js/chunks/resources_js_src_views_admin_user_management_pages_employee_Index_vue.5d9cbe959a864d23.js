  ...
  setup: function setup(props, context) {
    ...
    function saveModal() {
      if (form.value.validate()) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_5___default().post(singlePath + '/users/store', fd).then(function (response) {
        ...
        return (0,C_Users_marij_Desktop_Appointments_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              isLoading.value = true;
              axios__WEBPACK_IMPORTED_MODULE_5___default().put(singlePath + '/users/{id}/delete', {
                'id': item.id
              }).then(function (response) {
                if (response.data.status) {
    ...
    [
      ...
      _vm.data.length > 0
        ? _c("employee-table", {
            ...
            attrs: { users: _vm.data, title: "employee", role: "admin" },
          })
        : _vm._e(),
    ],
    1
                                          ...
                                          [
                                            ...
                                            _c(
                                              ...
                                              [
                                                ...
                                                _vm._v(" "),
                                                _c(vuetify_lib_components_VSwitch__WEBPACK_IMPORTED_MODULE_12__["default"], {
                                                  attrs: {
